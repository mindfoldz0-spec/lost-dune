...
/** @type {string} */
const CACHE_VERSION = '1786134041|120657265';
/** @type {string} */
const CACHE_PREFIX = 'MAYUR-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'LostDune.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["LostDune.html","LostDune.js","LostDune.offline.html","LostDune.icon.png","LostDune.apple-touch-icon.png","LostDune.audio.worklet.js","LostDune.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["LostDune.wasm","LostDune.pck","LostDune.side.wasm"];
